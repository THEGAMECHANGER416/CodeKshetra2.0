        ...
        <div className="flex h-full sm:h-screen w-full flex-col items-center justify-end rounded-lg">
          <div className="grid h-full w-full grid-cols-8 grid-rows-10 gap-4">
            ...
            <div className="col-span-full sm:col-span-4 row-span-3 sm:h-full sm:mb-0 row-start-2 sm:row-start-1 sm:col-start-3  sm:row-span-5 relative rounded-3xl bg-secondary">
              {/* row-start-2 sm:col-start-4 */}
              <div className="font-bold mt-4 text-white text-4xl">
                Codeक्षेत्र: The Ultimates
              </div>
              <div className="font-bold mt-4 text-black text-4xl">
                36-Hour Hackathon
              </div>
              <Button className="mt-4 text-lg p-3 w-40 rounded-xl">
                Register
              </Button>
              <img
                src="src/assets/logo.png"
                alt="logo"
                className="absolute bottom-0 left-1/2 bg-primary transform -translate-x-1/2 translate-y-1/2 h-24 w-24 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-80 lg:h-80 rounded-full border-2 border-background "
              />
            </div>
            ...
            <div className=" col-span-full sm:col-span-3 row-span-4 rounded-3xl bg-primary">
              ...
              <div className="flex space-x-4 items-center text-white justify-center mt-9">
                <div className="text-center">
                  <p className="lg:text-6xl md:text-4xl sm:text-2xl font-bold ">
                    30
                  </p>
                  <p className="text-sm sm:text-xs">Hours</p>
                </div>
                <div className="lg:text-6xl md:text-4xl sm:text-2xl font-bold mb-6">
                  :
                </div>
                <div className="text-center">
                  <p className="lg:text-6xl md:text-4xl sm:text-2xl font-bold">
              ...
              <div className="font-bold text-white mt-5 text-2xl">
            ...
            <div className="col-span-4 row-start-7 col-start-5 sm:col-span-2 row-span-2 sm:row-start-8 sm:col-start-4 rounded-3xl bg-primary">
              ...
              <div className="flex justify-evenly text-3xl mt-4 ">
