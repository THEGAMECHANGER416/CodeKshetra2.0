  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-[90vw] sm:max-w-[80vw] mt-[3rem]">
        <h2 className="md:text-[13rem] font-bebas text-8xl text-pink font-bold mb-[4rem] md:mb-[6rem] text-center">
          Prize Pool
        </h2>
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-16 md:space-x-4">
          ...
          >
            <PrizeCard title="2nd Prize" amount="₹20,000" position="left" icon="🥈" />
          </motion.div>
          <motion.div
          ...
          >
            <PrizeCard title="1st Prize" amount="₹30,000" position="center" icon="🏆" isFirst={true} />
          </motion.div>
          <motion.div
            ...
            className="flex-1 w-full md:max-w-[30%] lg:max-w-[25%]"
          >
            <PrizeCard title="3rd Prize" amount="₹15,000" position="right" icon="🥉" />
          </motion.div>
        </div>
        <motion.div
