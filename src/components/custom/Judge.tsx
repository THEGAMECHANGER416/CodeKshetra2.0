            ...
            <div
              ...
              className={`${
                ...
                index === 1 || index === judges.length - 2
                  ? "w-48 h-72 xl:w-56 xl:h-80 rounded-[100px]" : "w-46 h-72 xl:w-64 xl:h-80 rounded-xl"      
            ...
            <SwiperSlide key={index}>
              <div className="flex justify-center mb-10">
                <div
                  className={`${
                    index === 1 || index === judges.length - 2
                      ? "w-64 h-96 sm:w-72 sm:h-104 md:w-80 md:h-[300px] rounded-[100px]" 
                      : "w-72 h-96 sm:w-80 sm:h-96 md:w-96 md:h-112 rounded-lg"           
                  } bg-neutral-200/15 overflow-hidden flex justify-center items-center shadow-lg ${
